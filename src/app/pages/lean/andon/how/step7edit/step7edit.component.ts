...
@Component({
  selector: 'ngx-step7edit',
  templateUrl: './step7edit.component.html',
  styleUrls: ['./step7edit.component.scss']
})
export class Step7editComponent {
  @Input() howData: How;

  constructor(
    protected ref: NbDialogRef<Step7editComponent>,
