...
@Component({
  selector: 'ngx-step6edit',
  templateUrl: './step6edit.component.html',
  styleUrls: ['./step6edit.component.scss']
})
export class Step6editComponent {
  @Input() howData: How;
  ...
  constructor(
    protected ref: NbDialogRef<Step6editComponent>,
